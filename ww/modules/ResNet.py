...
class ResNet20(Base):
    def __init__(self, binW, binA):
        ...
        self.conv01= nn.Conv2d(3,16,3,padding=1)
        self.conv02= layers.BinaryConv2DCL(16,16) if binW else nn.Conv2d(16,16,3,padding=1)
        self.conv03= layers.BinaryConv2DCL(16,16) if binW else nn.Conv2d(16,16,3,padding=1)
        self.conv04= layers.BinaryConv2DCL(16,16) if binW else nn.Conv2d(16,16,3,padding=1)
        self.conv05= layers.BinaryConv2DCL(16,16) if binW else nn.Conv2d(16,16,3,padding=1)
        self.conv06= layers.BinaryConv2DCL(16,16) if binW else nn.Conv2d(16,16,3,padding=1)
        self.conv07= layers.BinaryConv2DCL(16,16) if binW else nn.Conv2d(16,16,3,padding=1)
        self.conv08= layers.BinaryConv2DCL(16,32) if binW else nn.Conv2d(16,32,3,padding=1)
        self.conv09= layers.BinaryConv2DCL(32,32) if binW else nn.Conv2d(32,32,3,padding=1)
        self.conv10= layers.BinaryConv2DCL(32,32) if binW else nn.Conv2d(32,32,3,padding=1)
        self.conv11= layers.BinaryConv2DCL(32,32) if binW else nn.Conv2d(32,32,3,padding=1)
        self.conv12= layers.BinaryConv2DCL(32,32) if binW else nn.Conv2d(32,32,3,padding=1)
        self.conv13= layers.BinaryConv2DCL(32,32) if binW else nn.Conv2d(32,32,3,padding=1)
        self.conv14= layers.BinaryConv2DCL(32,64) if binW else nn.Conv2d(32,64,3,padding=1)
        self.conv15= layers.BinaryConv2DCL(64,64) if binW else nn.Conv2d(64,64,3,padding=1)
        self.conv16= layers.BinaryConv2DCL(64,64) if binW else nn.Conv2d(64,64,3,padding=1)
        self.conv17= layers.BinaryConv2DCL(64,64) if binW else nn.Conv2d(64,64,3,padding=1)
        self.conv18= layers.BinaryConv2DCL(64,64) if binW else nn.Conv2d(64,64,3,padding=1)
        self.conv19= layers.BinaryConv2DCL(64,64) if binW else nn.Conv2d(64,64,3,padding=1)
        ...
        self.batn01=nn.BatchNorm2d(num_features=16, eps=0.01, momentum=0.99)
        self.batn02=nn.BatchNorm2d(num_features=16, eps=0.01, momentum=0.99)
        self.batn03=nn.BatchNorm2d(num_features=16, eps=0.01, momentum=0.99)
        self.batn04=nn.BatchNorm2d(num_features=16, eps=0.01, momentum=0.99)
        self.batn05=nn.BatchNorm2d(num_features=16, eps=0.01, momentum=0.99)
        self.batn06=nn.BatchNorm2d(num_features=16, eps=0.01, momentum=0.99)
        self.batn07=nn.BatchNorm2d(num_features=16, eps=0.01, momentum=0.99)
        self.batn08=nn.BatchNorm2d(num_features=32, eps=0.01, momentum=0.99)
        self.batn09=nn.BatchNorm2d(num_features=32, eps=0.01, momentum=0.99)
        self.batn10=nn.BatchNorm2d(num_features=32, eps=0.01, momentum=0.99)
        self.batn11=nn.BatchNorm2d(num_features=32, eps=0.01, momentum=0.99)
        self.batn12=nn.BatchNorm2d(num_features=32, eps=0.01, momentum=0.99)
        self.batn13=nn.BatchNorm2d(num_features=32, eps=0.01, momentum=0.99)
        self.batn14=nn.BatchNorm2d(num_features=64, eps=0.01, momentum=0.99)
        self.batn15=nn.BatchNorm2d(num_features=64, eps=0.01, momentum=0.99)
        self.batn16=nn.BatchNorm2d(num_features=64, eps=0.01, momentum=0.99)
        self.batn17=nn.BatchNorm2d(num_features=64, eps=0.01, momentum=0.99)
        self.batn18=nn.BatchNorm2d(num_features=64, eps=0.01, momentum=0.99)
        self.batn19=nn.BatchNorm2d(num_features=64, eps=0.01, momentum=0.99)
